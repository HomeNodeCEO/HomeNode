...
def parse_owner(soup: BeautifulSoup) -> Dict[str, Any]:
    ...
    # heading.  Prefer that complete heading value for this narrow case.  Do
    # not apply the rule to true multi-party ownership because each grid row
    # and its percentage must remain distinct.
