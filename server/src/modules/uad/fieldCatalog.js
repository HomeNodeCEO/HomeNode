...
const fields = [
  ...
  })),
  {
    ...
    uid: "1000.0103",
    reportFieldId: "2.001",
    label: "Individual borrower role",
    dataType: "enum",
    options: ["Borrower"],
    showWhen: { uid: "1000.0101", present: true },
    requiredWhen: { uid: "1000.0101", present: true },
    guidance: "UAD requires PartyRoleType with an individual borrower name.",
  },
  {
    section: "assignment",
    group: "Borrower",
    ...
    uid: "1000.0105",
    reportFieldId: "2.001",
    label: "Legal-entity borrower role",
    dataType: "enum",
    options: ["Borrower"],
    showWhen: { uid: "1000.0104", present: true },
    requiredWhen: { uid: "1000.0104", present: true },
    guidance: "UAD requires PartyRoleType with a legal-entity borrower name.",
  },
  {
    section: "assignment",
    group: "Seller",
    ...
    uid: "1000.0021",
    reportFieldId: "2.002",
    label: "Individual seller role",
    dataType: "enum",
    options: ["PropertySeller"],
  ...
  },
  {
    ...
    uid: "1000.0116",
    reportFieldId: "2.002",
    label: "Legal-entity seller role",
    dataType: "enum",
    options: ["PropertySeller"],
  ...
  },
  {
    section: "assignment",
    group: "Lender / client",
    contextKey: "assignment_client_primary_role",
    uid: "2400.0018",
    reportFieldId: "2.010",
    ...
    options: ["Client"],
    required: true,
    entityType: "assignment_contact",
  },
  {
    section: "assignment",
    group: "Lender / client",
    contextKey: "assignment_client_type_role",
    uid: "2400.0017",
    reportFieldId: "2.011",
    label: "Client role",
    dataType: "enum",
    options: ["Attorney", "Investor", "Lender", "ManagementCompany", "Other"],
    required: true,
    entityType: "assignment_contact",
  },
  {
    ...
    uid: "2400.0077",
    reportFieldId: "2.011",
    label: "Other client role",
    dataType: "string",
    maxLength: 33,
    showWhen: { uid: "2400.0017", equals: "Other" },
    requiredWhen: { uid: "2400.0017", equals: "Other" },
    entityType: "assignment_contact",
  },
  {
    section: "assignment",
    group: "Lender / client",
    contextKey: "assignment_client_name",
    uid: "2400.0013",
    reportFieldId: "2.012",
    label: "Company name",
    dataType: "string",
  ...
  ...[
    ["2400.0001", "Address line", "string", 100],
    ["2400.0002", "City", "string", 50],
    ["2400.0004", "State", "state", 2],
    ["2400.0003", "Postal code", "postal_code", 10],
  ].map(([uid, label, dataType, maxLength]) => ({
    section: "assignment",
    group: "Lender / client",
    contextKey: "assignment_client_address",
    uid,
    reportFieldId: "2.013",
    label,
    dataType,
