...
const styles = StyleSheet.create({
  ...
  title: { color: "#17251f", fontSize: 20, fontWeight: "800" },
  sectionTitle: { color: "#17251f", fontSize: 17, fontWeight: "800", marginTop: 12 },
  muted: { color: "#64766e", fontSize: 14, lineHeight: 20 },
  summary: { flexDirection: "row", gap: 8 },
  summaryValue: { flex: 1, color: "#17251f", backgroundColor: "#ffffff", borderRadius: 12, padding: 12, fontSize: 17, fontWeight: "800" },
  summaryLabel: { color: "#697a72", fontSize: 10, fontWeight: "600" },
  groupTabs: { flexDirection: "row", flexWrap: "wrap", gap: 7 },
  groupTab: { borderWidth: 1, borderColor: "#cbd7d0", backgroundColor: "white", borderRadius: 20, paddingHorizontal: 11, paddingVertical: 8 },
  groupTabSelected: { borderColor: "#1d5a43", backgroundColor: "#dbece3" },
  groupTabText: { color: "#607269", fontSize: 12, fontWeight: "700" },
  groupTabTextSelected: { color: "#1d5a43" },
  fieldList: { gap: 14 },
  rowBetween: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: 10 },
  label: { color: "#42574e", fontSize: 13, fontWeight: "700" },
  changed: { color: "#805f19", fontSize: 11, fontWeight: "700" },
  input: { backgroundColor: "white", borderWidth: 1, borderColor: "#cbd7d0", borderRadius: 10, padding: 12, fontSize: 15, marginTop: 5 },
  multiline: { minHeight: 90 },
  booleanRow: { flexDirection: "row", gap: 8, marginTop: 6 },
  booleanChoice: { flex: 1, alignItems: "center", padding: 10, borderWidth: 1, borderColor: "#cbd7d0", borderRadius: 10, backgroundColor: "white" },
  booleanChoiceSelected: { borderColor: "#1d5a43", backgroundColor: "#dbece3" },
  button: { backgroundColor: "#1d5a43", borderRadius: 11, paddingVertical: 13, paddingHorizontal: 14, alignItems: "center" },
  ...
  reviewCard: { backgroundColor: "white", borderWidth: 1, borderColor: "#dce4df", borderRadius: 13, padding: 14, gap: 7 },
  conflictCard: { backgroundColor: "#fff4e1", borderColor: "#dfbd79" },
  cardTitle: { color: "#17251f", fontSize: 15, fontWeight: "800", flex: 1 },
  badge: { color: "#1d5a43", backgroundColor: "#e0ece5", paddingHorizontal: 8, paddingVertical: 4, borderRadius: 14, overflow: "hidden", fontSize: 11, fontWeight: "700" },
  meta: { color: "#697a72", fontSize: 11, fontWeight: "700" },
  value: { color: "#17251f", fontSize: 14 },
  provenance: { color: "#73827c", fontSize: 11 },
  warning: { color: "#805f19", lineHeight: 19 },
  offline: { color: "#795b19", backgroundColor: "#fff2ce", borderRadius: 9, padding: 10, overflow: "hidden" },
  error: { color: "#9d302a", backgroundColor: "#fbe8e5", padding: 10, borderRadius: 9, overflow: "hidden" },
  complete: { color: "#24543f", backgroundColor: "#deece5", padding: 11, borderRadius: 9, overflow: "hidden" },
});
