...
import {
  ...
  purchaseContractBoolean,
  purchaseContractCurrency,
} from "../../services/purchaseContractAnalysis.js";
...
export const buildUadSalesContractAnalysis = buildPurchaseContractAnalysis;
...
export function uadPurchaseContractValues(candidates = []) {
  ...
  const price = purchaseContractCurrency(value("contract_price"));
  ...
  const concessions = purchaseContractCurrency(value("seller_concessions"));
  if (concessions != null) {
