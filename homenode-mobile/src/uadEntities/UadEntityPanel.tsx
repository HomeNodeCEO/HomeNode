...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: "#17251f", fontSize: 17, fontWeight: "800", marginTop: 10 },
  ...
  tab: { borderWidth: 1, borderColor: "#cbd7d0", backgroundColor: "white", borderRadius: 20, paddingHorizontal: 10, paddingVertical: 8 },
  tabSelected: { borderColor: "#1d5a43", backgroundColor: "#dbece3" },
  tabText: { color: "#607269", fontSize: 11, fontWeight: "700" },
  tabTextSelected: { color: "#1d5a43" },
  creator: { backgroundColor: "#eef4f0", borderRadius: 13, padding: 13, gap: 10 },
  input: { backgroundColor: "white", borderWidth: 1, borderColor: "#cbd7d0", borderRadius: 10, padding: 12, fontSize: 15 },
  button: { backgroundColor: "#1d5a43", borderRadius: 11, paddingVertical: 13, paddingHorizontal: 14, alignItems: "center" },
  secondaryButton: { backgroundColor: "#e0ece5", borderWidth: 1, borderColor: "#a9c2b5" },
  buttonText: { color: "white", fontWeight: "800" },
  secondaryButtonText: { color: "#1d5a43" },
  disabled: { opacity: 0.45 },
  pressed: { opacity: 0.82 },
  list: { gap: 9 },
  card: { backgroundColor: "white", borderWidth: 1, borderColor: "#dce4df", borderRadius: 13, padding: 13, gap: 7 },
  conflictCard: { backgroundColor: "#fff4e1", borderColor: "#dfbd79" },
  entityRow: { backgroundColor: "white", borderRadius: 10, padding: 11, flexDirection: "row", alignItems: "center", gap: 10 },
  flex: { flex: 1 },
  cardTitle: { color: "#17251f", fontSize: 14, fontWeight: "800" },
  meta: { color: "#697a72", fontSize: 11 },
  remove: { color: "#9d302a", fontSize: 11, fontWeight: "700" },
