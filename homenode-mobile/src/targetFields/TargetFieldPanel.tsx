...
const styles = StyleSheet.create({
  ...
  notice: { color: "#2f5948", backgroundColor: "#deece5", padding: 10, borderRadius: 10, fontSize: 12 },
  ...
  label: { color: "#42574e", fontSize: 13, fontWeight: "700", flex: 1 },
  ...
  choice: { borderWidth: 1, borderColor: "#cbd7d0", borderRadius: 10, paddingHorizontal: 10, paddingVertical: 9, backgroundColor: "white" },
  choiceSelected: { borderColor: "#1d5a43", backgroundColor: "#dbece3" },
  choiceText: { color: "#42574e", fontSize: 12 },
  ...
  conflictText: { color: "#795b19", fontSize: 12, lineHeight: 18 },
  ...
  error: { color: "#9d302a", backgroundColor: "#fbe8e5", padding: 10, borderRadius: 10 },
  offline: { color: "#805f19", fontSize: 12 },
  complete: { color: "#2f5948", fontSize: 13, marginTop: 8 },
});
