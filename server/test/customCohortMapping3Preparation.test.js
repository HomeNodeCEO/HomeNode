...
for (const [name, mutate] of [
  ...
  ['unknown compact mapping version', i => setMetadata(i, m => { m.mapping_version = 6; })],
  ['combined compact version with witness1 rows', i => setMetadata(i, m => { m.mapping_version = 5; })],
  ['CAD-only compact version with witness rows', i => setMetadata(i, m => { m.mapping_version = 4; })],
