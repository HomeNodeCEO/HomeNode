      ...
      <div className="p-4 sm:p-6">
        ...
        {activeSection === "sales_comparison" && (
          <div className="mb-5 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm leading-6 text-emerald-950">
            Sections 22A–22F establish each comparable's official general information, source trail, property-rights details, project or PUD information, Site facts and water frontage, repeatable dwellings, mechanical systems, energy-efficient and green features, typed adjustments, and required verified photo. Bodies of water remain linked to their Site Influence; construction, heating, and cooling remain linked to the exact comparable dwelling; renewable components, certifications, and efficiency ratings remain linked to the comparable property. Subject energy and green facts redisplay from Section 6 without duplicate entry. Those relationships keep future MISMO XML, mobile evidence, and comparable-search suggestions on one canonical record. Only an appraiser save confirms suggested data for the UAD report.
          </div>
        )}
