...
Exact overall C1-C6 and Q1-Q6 ratings map only to the UAD overall-condition and overall-quality fields; they are never copied into exterior or interior component ratings. Rating ranges remain omissions for appraiser reconciliation. Annual and quarterly HOA dues are normalized to monthly amounts, while unknown frequencies and missing mandatory monthly fees remain explicit omissions. An explicit fireplace count becomes a Whole Home amenity suggestion, and a non-vehicle additional improvement becomes an Outdoor Living suggestion only when its type and every UAD-required material or area fact are present. Generic pool flags, incomplete improvements, amenity defects, heating fuel and below-grade location, cost-to-cure component placement, component-level defects, project data sources, common amenities, included utilities, combined room-count adjustments, out-of-range values, missing Custom sources, conflicting classifications, zoning compliance, parcel-use descriptions, parking-space counts, and other classifications that require appraisal judgment are disclosed as omissions instead of being guessed.
